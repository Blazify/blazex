...
use llvm_sys::transforms::ipo::{
    ...
    LLVMAddGlobalDCEPass, LLVMAddGlobalOptimizerPass, LLVMAddIPConstantPropagationPass,
...
use llvm_sys::transforms::scalar::{
    ...
    LLVMAddCFGSimplificationPass, LLVMAddConstantPropagationPass,
    ...
    LLVMAddIndVarSimplifyPass, LLVMAddInstructionCombiningPass, LLVMAddJumpThreadingPass,
    LLVMAddLICMPass, LLVMAddLoopDeletionPass, LLVMAddLoopIdiomPass, LLVMAddLoopRerollPass,
    LLVMAddLoopRotatePass, LLVMAddLoopUnrollPass, LLVMAddLoopUnswitchPass,
