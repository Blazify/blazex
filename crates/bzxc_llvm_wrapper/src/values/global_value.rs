use llvm_sys::core::{
    ...
    LLVMSetThreadLocalMode, LLVMSetUnnamedAddress, LLVMSetVisibility,
};
use llvm_sys::core::{LLVMGetUnnamedAddress, LLVMGlobalSetMetadata};
use llvm_sys::prelude::LLVMValueRef;
use llvm_sys::{LLVMThreadLocalMode, LLVMUnnamedAddr};
